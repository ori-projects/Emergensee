...
from app.services.preprocesses.cassi_preprocessor import CassiPreprocessor
from app.services.proccessors.cassi_processor import CassiProcessor

class Cassi:
    """
    A class representing the Cassi dataset processing pipeline.

    Attributes:
    _instance (Cassi): Singleton instance of the Cassi class.
    path (str): Path to the raw Cassi dataset.
    df (DataFrame or None): Processed DataFrame of Cassi dataset.
    df_raw (DataFrame or None): Raw DataFrame loaded from Cassi dataset.
    ...
    preprocessor (CassiPreprocessor): Instance of CassiPreprocessor for data preprocessing.
    processor (CassiProcessor): Instance of CassiProcessor for model processing.
    ...
    Methods:
    __new__(): Singleton pattern to ensure only one instance of Cassi class exists.
    initialize(): Initializes instance attributes and sets up necessary objects.
    preprocess(): Executes data preprocessing steps using CassiPreprocessor.
    process(): Trains models and evaluates their performance using CassiProcessor.
    ...
    def __new__(cls):
        """
        Ensures only one instance of Cassi class exists (Singleton pattern).

        Returns:
        Cassi: The single instance of the Cassi class.
        """
    ...
    def initialize(self):
        ...
        self.X_test = None
        self.y_test = None
        self.preprocessor = CassiPreprocessor()
        self.processor = CassiProcessor()
    ...
    def preprocess(self):
        """
        Executes data preprocessing steps using CassiPreprocessor.
        """
